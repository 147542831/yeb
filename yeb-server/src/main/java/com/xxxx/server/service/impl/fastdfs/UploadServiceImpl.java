package com.xxxx.server.service.impl.fastdfs;
import com.alibaba.fastjson.JSON;
import com.github.tobato.fastdfs.domain.fdfs.StorePath;
import com.github.tobato.fastdfs.service.FastFileStorageClient;
import com.xxxx.server.config.fastdfs.UploadProperties;
...
public class UploadServiceImpl implements IUploadService {
     ...
     */
    @Override
    public String upload(MultipartFile multipartFile, Admin admin) throws IOException {




        // 校验用户是否存在
        AssertUtil.isTrue(StringUtils.isBlank(admin.toString()), "登录状态异常！");
